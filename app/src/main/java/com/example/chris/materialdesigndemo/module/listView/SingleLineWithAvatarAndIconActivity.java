 ...
 */
public class SingleLineWithAvatarAndIconActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        UIAdapter adapter = new UIAdapter(this, R.layout.listview_single_line_with_avatar_and_icon, 20);
