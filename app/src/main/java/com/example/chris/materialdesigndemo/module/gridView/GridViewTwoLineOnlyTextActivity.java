 ...
 */
public class GridViewTwoLineOnlyTextActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter(new UIAdapter(this, R.layout.listview_grid_two_line_only_text, 20));
